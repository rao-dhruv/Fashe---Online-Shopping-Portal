...
$_POST['last_name'] = trim($_POST['last_name']);
	try {
		...
		if (strlen($_POST['first_name']) >1 && strlen($_POST['first_name']) <16 ) {
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >0 ) {
						...
						$result = mysql_query("INSERT INTO admin (firstName,lastName,email,mobile,address,password,type) VALUES ('$_POST[first_name]','$_POST[last_name]','$_POST[email]','$_POST[mobile]','$_POST[signupaddress]','$_POST[password]','$_POST[admintype]')");
